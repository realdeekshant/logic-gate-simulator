...
from sub_window import SimulatorSubWindow
...
class SimulatorWindow(NodeEditorWindow):

    def initUI(self):
        self.name_company = 'deekshant'
        self.name_product = 'Logic Gate Simulator'
    ...
    def about(self):
        QMessageBox.about(self, "About Logic Gate Simulator",
                          'Simple node based logic gate simulator made with Python by '
                          '<b><a href="https://deekshantyadav.github.io/aboutme"><font '
                          'color="white">deekshant</font><a/></b> special thanks to '
                          '<b><a href="https://blenderfreak.com"><font color="white">blenderfreak</font><a/></b> ')
    ...
    def createMdiChild(self, child_widget=None):
        nodeeditor = child_widget if child_widget is not None else SimulatorSubWindow()
